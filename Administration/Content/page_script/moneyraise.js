...
$(document).ready(() => {
    $("#StartupGrid").kendoGrid({
        dataSource: {
            ...
            transport: {
                read: {
                    url: "/MoneyRaise/GetAllMoneyRaiseList"
        ...
        { field: "Value", title: "Money Raise", width: 140, filterable: false },
...
$("#editStartupForm").submit(function (e) {
    ...
    $.ajax({
        url: GetBaseURL() + "MoneyRaise/EditMoneyRaise",
        method: "POST",
        ...
        success: function (response) {
            if (response == "OK") {
                ...
                swal("Success!", "Money raise Updated Successfully", "success");
...
$("#newStartupForm").submit(function (e) {
    ...
    $.ajax({
        url: GetBaseURL() + "MoneyRaise/AddMoneyRaise",
        method: "POST",
        ...
        success: function (response) {
            if (response == "OK") {
                ...
                swal("Success!", "Money raise Added Successfully", "success");
                $('#StartupGrid').data('kendoGrid').dataSource.read()
...
function Edit(Value) {
    ...
    $.ajax({
        url: GetBaseURL() + "MoneyRaise/GetMoneyRaise/",
        method: "GET",
        data: { ID: Value },
        dataType: 'json',
