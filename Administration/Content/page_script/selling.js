...
$("#editStartupForm").submit(function (e) {
    ...
    $.ajax({
        url: GetBaseURL() + "Selling/EditSelling",
        method: "POST",
...
$("#newStartupForm").submit(function (e) {
    ...
    $.ajax({
        url: GetBaseURL() + "Selling/AddSelling",
        method: "POST",
        ...
        success: function (response) {
            if (response == "OK") {
                ...
                swal("Success!", "Selling Added Successfully", "success");
                $('#StartupGrid').data('kendoGrid').dataSource.read()
...
function Edit(Value) {
    ...
    $.ajax({
        url: GetBaseURL() + "selling/GetSelling/",
        method: "GET",
        data: { ID: Value },
        dataType: 'json',
